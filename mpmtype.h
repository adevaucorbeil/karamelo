#ifndef MPM_MPMTYPE_H
#define MPM_MPMTYPE_H
...
#define MPI_MPM_TAGINT MPI_INT
#define MPI_MPM_IMAGEINT MPI_INT
#define MPI_MPM_BIGINT MPI_LL
...
#define MPI_MPM_TAGINT MPI_LL
#define MPI_MPM_IMAGEINT MPI_LL
#define MPI_MPM_BIGINT MPI_LL
