...
FixStyle(indent/hertz/nodes/symz, FixIndentHertzNodesSymZ)

#else

#ifndef MPM_FIX_INDENT_HERTZ_NODES_SYM_Z_H
#define MPM_FIX_INDENT_HERTZ_NODES_SYM_Z_H

#include "fix.h"
#include "var.h"
#include <vector>

class FixIndentHertzNodesSymZ : public Fix {
public:
  FixIndentHertzNodesSymZ(class MPM *, vector<string>);
  ~FixIndentHertzNodesSymZ();
  void setmask();
  void init();
  void setup();
