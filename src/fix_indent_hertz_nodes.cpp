...
FixIndentHertzNodes::FixIndentHertzNodes(MPM *mpm, vector<string> args)
    : Fix(mpm, args) {
  if (args.size() < Nargs) {
  ...
  cout << "Creating new fix FixIndentHertzNodes with ID: " << args[0] << endl;
  id = args[0];
...
FixIndentHertzNodes::~FixIndentHertzNodes() {}

void FixIndentHertzNodes::init() {}

void FixIndentHertzNodes::setup() {}

void FixIndentHertzNodes::setmask() {
  mask = 0;
  mask |= POST_PARTICLES_TO_GRID;
}

void FixIndentHertzNodes::post_particles_to_grid() {
  // cout << "In FixIndentHertzNodes::post_particles_to_grid()\n";
